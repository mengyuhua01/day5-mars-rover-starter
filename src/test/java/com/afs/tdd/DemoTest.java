...
class DemoTest {
    ...
    @Test
    void should_turn_left_90_degrees_when_executeCommand_given_L_Direction_S() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.S));
        //when
        marsRover.executeCommand("L");
    ...
    @Test
    void should_turn_left_90_degrees_when_executeCommand_given_L_Direction_E() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.E));
        //when
        marsRover.executeCommand("L");
    ...
    @Test
    void should_turn_left_90_degrees_when_executeCommand_given_L_Direction_W() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.W));
        //when
        marsRover.executeCommand("L");
    ...
    @Test
    void should_turn_right_90_degrees_when_executeCommand_given_R_Direction_N() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.N));
        //when
    ...
    @Test
    void should_turn_right_90_degrees_when_executeCommand_given_R_Direction_S() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.S));
        //when
        marsRover.executeCommand("R");
    ...
    @Test
    void should_turn_right_90_degrees_when_executeCommand_given_R_Direction_E() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.E));
        //when
        marsRover.executeCommand("R");
    ...
    @Test
    void should_move_backward_when_executeCommand_given_B_Direction_N() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.N));
        //when
    ...
    @Test
    void should_move_backward_when_executeCommand_given_B_Direction_S() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.S));
        //when
        marsRover.executeCommand("B");
    ...
    @Test
    void should_move_backward_when_executeCommand_given_B_Direction_E() {
        //given
        MarsRover marsRover = new MarsRover(new Location(0,0,Direction.E));
        //when
        marsRover.executeCommand("B");
